      ...
      <div className="grid gap-8 xl:grid-cols-[1fr_340px]">
        ...
        <aside className="space-y-6">
          ...
          <div className="rounded-3xl border bg-blue-50 p-6">
            <h2 className="mb-2 text-sm font-bold text-blue-900">⏱ Review Time</h2>
            <p className="text-sm text-blue-700">Most gigs are reviewed within 24 hours. You'll get notified when it goes live.</p>
          </div>
        </aside>
      </div>
    </main>
